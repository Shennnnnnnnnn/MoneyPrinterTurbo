...
ENGLISH_FALLBACK_KEYS = frozenset(
    {
        ...
        "Continue Generation",
        "Continue Generation Confirmation",
        "Custom API Endpoint",
        "API Platform",
        ...
        "Script Paragraph Summary",
        "Script Paragraph Item",
        "Script Paragraph Preview",
        "Script Paragraph Preview Summary",
        "Script Segmentation Complete",
        "Script Segmentation Failed",
        ...
        "OpenAI Image Parallelism",
        "OpenAI Image Parallelism Help",
        "Paragraph Image Duration Automatic",
        ...
        "Smart Segment Script",
        "Unavailable AI Video Model",
        "View Script Paragraphs",
        "Logout",
        "Remember Login",
        "Invalid Username or Password",
        "Task Files",
        "No Task Files",
        "Task Files Truncated",
        "File Unavailable",
        "Download",
        "Package All Files",
